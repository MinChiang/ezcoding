...
public class AccountPasswordVerificationAuthenticationServiceImpl extends AbstractAuthenticationService {
    ...
    public AccountPasswordVerificationAuthenticationServiceImpl(AuthenticationManager authenticationManager, IBasicUserService basicUserService, RedisVerificationServiceImpl imageVerificationService) {
