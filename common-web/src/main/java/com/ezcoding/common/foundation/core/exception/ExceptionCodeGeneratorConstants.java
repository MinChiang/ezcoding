...
public interface ExceptionCodeGeneratorConstants {
    ...
    WebExceptionCodeGenerator GEN_COMMON_SERVICE_NOT_AVAILABLE_ERROR = new WebExceptionCodeGenerator(DEFAULT_MODULE_LAYER_MODULE, 8, "COMMON_SERVICE_NOT_AVAILABLE_ERROR");
