...
import com.ezcoding.account.module.management.dao.DepartmentMapper;
...
import static com.ezcoding.account.module.management.exception.ManagementExceptionConstants.PARENT_DEPARTMENT_NOT_FOUND;
...
public class DepartmentService extends ServiceImpl<DepartmentMapper, Department> {
    ...
    public Department createDepartment(Department department, IUser user) {
        ...
        if (parentId != null) {
            ...
            AssertUtils.mustNotNull(parentDepartment, PARENT_DEPARTMENT_NOT_FOUND);
    ...
    public void assertDepartmentValid(Department department) {
        AssertUtils.mustTrue(department != null && department.getStatus() == DepartmentStatusEnum.RUNNING, GROUP_NOT_VALID);
    }
