...
import com.ezcoding.account.extend.spring.security.failureHandler.CustomAuthenticationFailureHandler;
import com.ezcoding.account.extend.spring.security.filter.MultipleAuthenticationFilter;
import com.ezcoding.account.extend.spring.security.provider.*;
import com.ezcoding.account.extend.spring.security.successHandler.LoginRecordSuccessHandler;
import com.ezcoding.account.extend.spring.security.successHandler.SuccessHandlerChain;
...
import com.ezcoding.account.module.user.core.authentication.*;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedHeaders(ImmutableList.of(GlobalConstants.Header.AUTHORIZATION, "Cache-Control", "Content-Type"));
