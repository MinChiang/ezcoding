package com.ezcoding.account.common.exception;
 ...
 */
public abstract class AbstractAccountApplicationException extends AbstractApplicationException {

    public AbstractAccountApplicationException(String moduleCode, String detailCode, String message, Throwable cause) {
