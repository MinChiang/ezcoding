package com.ezcoding.account.extend.spring.security.tokenService;
 ...
 */
public class CustomTokenServicce implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        if (this.authenticationManager != null && !authentication.isClientOnly()) {
            ...
            Object userAuthenticationDetail = authentication.getUserAuthentication().getDetails();
            if (userAuthenticationDetail != null) {
                ((PreAuthenticatedAuthenticationToken) user).setDetails(userAuthenticationDetail);
            }
    ...
    private OAuth2Authentication createRefreshedAuthentication(OAuth2Authentication authentication, TokenRequest request) {
        ...
        if (authentication.getUserAuthentication() != null) {
            narrowed.setDetails(authentication.getUserAuthentication().getDetails());
        }
        return narrowed;
    }
