...
import com.ezcoding.common.sdk.common.UrlConstants;
...
public class SdkImpl implements Sdk {
    ...
    private String completeUrl(String relativeUrl) {
        return this.sdkConfig.baseUrl + relativeUrl;
    }
    ...
    public Token loginByAccountPassword(String account, String password, DeviceTypeEnum deviceType) throws IOException {
        ...
        UserLoginRequestParam userLoginRequestParam = UserLoginRequestParam.createByAccountPassword(account, password, deviceType);
        RequestMessage<UserLoginRequestParam> requestMessage = MessageFactory.buildRequestMessage(userLoginRequestParam);
    ...
    @Override
    public Token loginByAccountPassword(LoginByAccountPasswordParam param) {
        return null;
    }

    @Override
    public Token loginByEmailPassword(LoginByEmailPasswordParam param) {
        return null;
    }

    @Override
    public Token loginByPhonePassword(LoginByPhonePasswordParam param) {
        return null;
    }

    @Override
    public Token loginByPhoneMessageCode(LoginByPhoneMessageCodeParam param) {
        return null;
    }

    @Override
    public Token loginByAccountPasswordVerificationCode(LoginByAccountPasswordVerificationCodeParam param) {
        return null;
    }

    @Override
    public String sendMessageCodeReceiveReceipt(String phone) {
        return null;
    }
