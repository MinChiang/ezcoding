package com.ezcoding.base.web.extend.spring.security.entryPoint;
...
import static com.ezcoding.common.foundation.core.exception.CommonApplicationExceptionConstants.COMMON_TOKEN_PARSE_ERROR;
...
public class CustomOAuth2AuthenticationEntryPoint extends OAuth2AuthenticationEntryPoint {
    ...
    protected ResponseEntity<?> enhanceResponse(ResponseEntity<?> response, Exception exception) {
        ...
        return new ResponseEntity<Object>(MessageBuilder.getInstance().buildErrorResponseMessage(COMMON_TOKEN_PARSE_ERROR, null), update, response.getStatusCode());
    }
